...
@section('content')
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
            <a href="{{ route('dashboard', ['tab' => 'statistik']) }}" class="nav-link @if ($currentTab === 'statistik') active @endif" role="tab"
                aria-selected="@if ($currentTab === 'statistik') true @else false @endif">
                Statistik
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ route('dashboard', ['tab' => 'grafik']) }}" class="nav-link @if ($currentTab === 'grafik') active @endif" role="tab"
